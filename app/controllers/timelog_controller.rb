...
class TimelogController < ApplicationController
	...
	def all
		...
		respond_to do |format|
			...
			format.csv {
				...
				format.csv  { send_data(report_to_csv(@all_records), :type => 'text/csv; header=present', :filename => 'all.csv') }
			}
	...
	def free
		...
		@all_records = []
		#大于 , 小于
		if params[:time_more_than].present?
			start_at = Date.parse(params[:time_more_than])
		else
				# puts "..........................____________."
			start_at = Date.today
		end
